...
# Model Configuration
MODEL_ARGS=(
    --model_path "/home/kuowei/CogVideo/CogVideoX1.5-5B-I2V"
...
OUTPUT_ARGS=(
    --output_dir "/home/kuowei/cogvideo_diffuser_fineturn_transformer_v2"
    --report_to "tensorboard"
)

# Data Configuration
DATA_ARGS=(
    --data_root "/home/kuowei/bridge_finetune_gt_1000"
...
TRAIN_ARGS=(
    --train_epochs 100 # number of training epochs ？是不是有点太大了
    --seed 42 # random seed
