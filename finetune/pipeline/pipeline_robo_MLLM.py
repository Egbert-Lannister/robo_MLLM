...
from ..transformer.transformer import RoboMultiTransformerModel
from .robo_MLLM_PipelineOutput import RoboMultiPipelineOutput
...
class RoboMultiImageToVideoPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def __init__(
        ...
        transformer: RoboMultiTransformerModel,
    ...
    def __call__(
        ...
        max_sequence_length: int = 226,
        device: Optional[torch.device] = None,
    ) -> Union[RoboMultiPipelineOutput, Tuple]:
        ...
        if not return_dict:
            return (video, predicted_actions)

        return RoboMultiPipelineOutput(frames=video, actions=predicted_actions)
